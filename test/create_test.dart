...
void main() {
  testWidgets('ScheduleMeetingScreen UI Test', (WidgetTester tester) async {
    ...
    expect(find.widgetWithText(ElevatedButton, 'Schedule Meeting'), findsOneWidget);
    ...
    await tester.enterText(find.byType(TextField).at(2), 'mentor@example.com, mentee@example.com');
    ...
    await tester.tap(find.byType(ListTile).at(1)); // Tap the Start Time ListTile
    await tester.pumpAndSettle();
    await tester.tap(find.text('OK'));
    await tester.pumpAndSettle();
