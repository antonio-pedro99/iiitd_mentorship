...
class MeetingDetailsPage extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              meetingDetailCard(Icons.description, 'Description', meeting.description),
              meetingDetailCard(Icons.email, 'Email IDs', meeting.emailIDs),
              meetingDetailCard(Icons.calendar_today, 'Start', meeting.from.toString()),
              meetingDetailCard(Icons.calendar_today, 'End', meeting.to.toString()),
              SizedBox(height: 20),
  ...
  Widget cancelMeetingButton(BuildContext context) {
    return ElevatedButton.icon(
      ...
      label: Text('Cancel Meeting', style: TextStyle(color: Colors.white)),
